...
const Signup = () => {
    ...
    useEffect(() => {
        const fetchApiKey = async () => {
            try {
                const response = await fetch('/api/getIMGBBAPI', {
                    method: 'GET',
                });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('/api/createCardPublic', {
                method: 'POST',
                headers: {
            ...
            <div className="bg-white p-8 rounded-lg shadow-md w-96">
                <div className="text-center mt-2 text-gray-500">
                    <div className='flex flex-col items-center mt-2 text-gray-500'>
                        ...
                        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Submit New Tool</h2>
                    </div>
